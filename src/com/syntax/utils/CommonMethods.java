...
public class CommonMethods extends Base{ // we extended to Base class as there is a driver browser method
...
// we are going to develop the common method that will 
	...
	public static void waitClick(WebElement element) { //waiting till the element will be clickble
	...
	public static void switchToChildWindow() {
		...
		/**
		 * method will select a date from the calendar. 
		 * @param element
		 * @param text
		 */
		public static void selectCalendarDate(List <WebElement> element, String text) {
			...
			for (WebElement pickDate:element) {
				if(pickDate.isEnabled()) {
					if (pickDate.getText().equalsIgnoreCase(text)) {
					pickDate.click();
					break;
